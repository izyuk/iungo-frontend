                ...
                <div className="wrap wrapFix2">
                    ...
                    <div className="contentWrapWithTopBorder">
                        <div className="template">
                            <svg version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 58 58"
                                 ...
                                 height="230px"><g><g>
                                    <path
                                        ...
                                        data-original="#000000" className="active-path" data-old_color="#000000" fill="#768197"/>
                                    <path
                            ...
                            <Link onClick={this.addNewCP} className={"addNewCPButton"} to={`/captive-portals/new`}>Create New</Link>
                        </div>
                    </div>
                </div>
